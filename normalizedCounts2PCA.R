...
legend("topright",legend=c("Warming environment", "Control environment", "Control Regime", "Warming Regime", "Low latitude", "High latitude"),col=c("red", "blue","grey38", "grey38", "grey38", "grey38"), lty = c(0, 0, 0), cex=0.8, pch = c(16, 16, 16, 15, 16, 21))
